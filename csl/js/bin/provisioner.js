...
function listTrustContents(){
    try {
        if(((trustStoreFile.indexOf('.json') > -1) && JSON.parse(dcl.$port.file.load(trustStoreFile)).clientId) || (trustStoreFile.indexOf('.json') < 0)){
            ...
            var tam = new dcl.device.TrustedAssetsManager();
            ...
            if (tam.getConnectedDevices() && Object.keys(tam.getConnectedDevices()).length > 0) {
                console.log('Connected devices: ' + JSON.stringify(tam.getConnectedDevices()));
            } else {
            ...
            var tam = new ecl.enterprise.TrustedAssetsManager();
            console.log('Trusted assets store: '+trustStoreFile);
            console.log('Server host: '+tam.getServerHost());
            console.log('Server port: '+tam.getServerPort());
        }
